    ...
    return (
        <div className='my-40 grid md:grid-cols-12 gap-8 max-w-screen-2xl mx-auto w-[94%]'>
            <div className='md:col-span-5 my-auto'>
                <h2 className='text-6xl font-bold'>Why Choose, <br /> <span className='bg-gradient-to-r dark:from-[#4d46b0] dark:to-[#872a79] from-[#8cbefa] to-[#f4b4fa] text-transparent bg-clip-text'>NanoTasks</span></h2>
            ...
            <div className='md:col-span-7 grid md:grid-cols-2 grid-rows-2'>
                ...
                <div className='h-fit border rounded-md p-4 m-2 bg-gray-100/40 dark:bg-[#1b1220] dark:border-none'>
                ...
                <div className='row-span-2 border rounded-md p-5 m-2 bg-gradient-to-br dark:border-none dark:from-[#1d1a3f] dark:to-[#34122f] from-[#e7f1fe] to-[#fef4ff]'>
                    ...
                    <button className='p-1 px-4 mx-10 font-semibold text-lg bg-gradient-to-r dark:from-[#4d46b0] dark:to-[#872a79] from-[#aed1fc] to-[#fbdffd] rounded-md'>Get Started</button>
                </div>
