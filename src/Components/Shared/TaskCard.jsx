...
const TaskCard = ({ task }) => {
    ...
    return (
        <div className='p-1 h-fit rounded-lg bg-gradient-to-r dark:from-[#342e70] dark:to-[#5b1a51] from-[#abcffb] to-[#fbcfff]'>
            <div className=" p-[6px] rounded-lg bg-base-100 dark:bg-[#110b14] shadow-xl">
                <div className='h-full rounded-md border-2 dark:bg-[#221827] '>
                    ...
                    <div className="p-3 h-1/2 ">
                        ...
                        <h2 className="text-3xl font-bold h-20">{task_title}</h2>
                        ...
                        whileTap={{ scale: 0.8 }}
                        className='pb-0'>
                            <Link to={`/dashboard/tasklist/${_id}`} className="btn w-full mt-2 text-lg dark:text-white dark:border-none bg-gradient-to-r dark:from-[#342e70] dark:to-[#5b1a51] from-[#b2d4fd] to-[#fac8fe]">View Details</Link>
                        </motion.div>
                    </div>
                </div>
            </div>
