...
const Safety = () => {
    return (
        <div className='grid md:grid-cols-2 my-32'>
            ...
            <div className='bg-gradient-to-r from-[#cbe2ff] to-[#f8d3fc] dark:from-[#1d1a3f] dark:to-[#34122f] p-32 py-44 '>
                <motion.img whileHover={{ scale: 1.2 }} className='mx-auto w-56' src={privacy} alt="" />
            </div>

            <div className='bg-[#e6e9ed] dark:bg-[#1b1220] text-lg p-12 py-28 lg:p-32 lg:py-44'>
