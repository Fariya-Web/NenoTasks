            ...
            <div className='md:flex justify-between flex-row-reverse'>
                ...
                <div className='md:w-[48%] my-auto'>
                    <div className="collapse collapse-arrow border-b border-[#f8d3fc] rounded-none my-2">
                        ...
                        <div className="collapse-title text-xl font-medium">What is NanoTasks?</div>
                        <div className="collapse-content">
                            <p>NanoTasks is a micro-tasking platform that connects users with simple tasks they can complete to earn money quickly and efficiently.</p>
                        </div>
                    </div>
                    <div className="collapse collapse-arrow border-b border-[#f8d3fc] rounded-none my-2">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title text-xl font-medium"> How do I start earning on NanoTasks?</div>
                        <div className="collapse-content">
                    ...
                    <div className="collapse collapse-arrow border-b border-[#f8d3fc] rounded-none my-2">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title text-xl font-medium">Are there any fees to join NanoTasks?</div>
                        <div className="collapse-content">
                            <p>No, joining NanoTasks is completely free. You can start earning without any upfront costs.</p>
                        </div>
                    </div>
                    <div className="collapse collapse-arrow border-b border-[#f8d3fc] rounded-none my-2">
                        <input type="radio" name="my-accordion-2" />
                    ...
                    <div className="collapse collapse-arrow border-b border-[#f8d3fc] rounded-none my-2">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title text-xl font-medium"> What types of tasks can I find on NanoTasks?</div>
                        <div className="collapse-content">
