    ...
    return (
        <div className='h-screen bg-gradient-to-r from-[#ecf5ff] to-[#fef1ff]'>
            <div className='text-center h-fit '>
                ...
                The page you're looking for seems to have wandered off. It might have been moved, deleted, or never existed in the first place. Don't worry—let's get you back on track! Head back to the homepage or use the navigation to find what you need.
                </p>
                <div className=''>
