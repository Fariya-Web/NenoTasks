...
const WorkerCard = ({ worker }) => {
    ...
    return (
        <div className='p-[2px] border dark:border-none rounded-3xl bg-gradient-to-r from-[#abcffb] to-[#fbcfff] dark:from-[#2d2961] dark:to-[#571e4f]'>
            <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.8 }}
                className='bg-white dark:bg-[#1b1220] p-2 rounded-3xl relative group'>
